...
<div align="center">
    ...
    <p><b>Choose from three different animation types for button interactions:</b><br>
    	<b></br>1.Enlarging Icon Animation**: The button's icon enlarges when pressed.<b></b>
	<b></br>2.Fill Bar Animation**: The button expands to fill the bar's width or height on click.<b></b>
	<b></br>3.Oppose Color Animation**: The button swaps its icon and background colors upon interaction.<b></b></p>
</div>
